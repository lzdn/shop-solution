...
public class CustomInvocationSecurityMetadataSourceService implements FilterInvocationSecurityMetadataSource {
	...
	private void loadResourceDefine() { // 一定要加上@PostConstruct注解
		 ...
		 * Collection<ConfigAttribute> defaultAtts = new ArrayList<ConfigAttribute>(); defaultAtts.add(defaultRole);
	...
	public Collection<ConfigAttribute> getAttributes(Object object) throws IllegalArgumentException {
		...
		// 此处如果返回为空 ，那么com.xuexi.security.CustomAccessDecisionManager.decide 不会被执行，
		// 所以加了默认的权限
